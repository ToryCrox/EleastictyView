 ...
 *
 *  从support包V27.1.0拷贝过来
 * function: 为了适配弹性控件
 *      description:滑动松手后抵达边缘时的速度为实际速度
 */
public class AbsorbNestedScrollView extends FrameLayout implements NestedScrollingParent,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(AbsorbNestedScrollView v, int scrollX, int scrollY,
    ...
    public AbsorbNestedScrollView(@NonNull Context context) {
        this(context, null);
    }

    public AbsorbNestedScrollView(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final AbsorbNestedScrollView nsvHost = (AbsorbNestedScrollView) host;
